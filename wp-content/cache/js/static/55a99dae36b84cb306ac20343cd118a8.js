/* Thursday 12th of September 2019 10:40:17 AM*/
...
(function(dojo){ dojo.addOnLoad(function(){
            ...
            new AccordionMenu({
                node: dojo.query('#nextend-accordion-menu-unique69eba50 dl.level1')[0],
                instance: 'nextend-accordion-menu-unique69eba50',
                url: '',
                moduleid: 0,
            ...
            dojo.query('.noscript').removeClass('noscript');
            new AccordionMenu({
                node: dojo.query('#nextend-accordion-menu-unique4823758 dl.level1')[0],
                instance: 'nextend-accordion-menu-unique4823758',
                url: '',
                moduleid: 0,
                classPattern: /nextend-nav-[0-9]+/,
                mode: 'onmouseenter', 
            ...
            dojo.query('.noscript').removeClass('noscript');
            new AccordionMenu({
                node: dojo.query('#nextend-accordion-menu-uniquec3cbd85 dl.level1')[0],
                instance: 'nextend-accordion-menu-uniquec3cbd85',
                url: '',
                moduleid: 0,
                classPattern: /nextend-nav-[0-9]+/,
                mode: 'onmouseenter', 
            ...
            dojo.query('.noscript').removeClass('noscript');
            new AccordionMenu({
                node: dojo.query('#nextend-accordion-menu-unique6add04 dl.level1')[0],
                instance: 'nextend-accordion-menu-unique6add04',
                url: '',
                moduleid: 0,
                classPattern: /nextend-nav-[0-9]+/,
                mode: 'onmouseenter', 
            ...
            dojo.query('.noscript').removeClass('noscript');
            new AccordionMenu({
                node: dojo.query('#nextend-accordion-menu-uniquefa95190 dl.level1')[0],
                instance: 'nextend-accordion-menu-uniquefa95190',
                url: '',
                moduleid: 0,
                classPattern: /nextend-nav-[0-9]+/,
                mode: 'onmouseenter', 
            ...
            dojo.query('.noscript').removeClass('noscript');
            new AccordionMenu({
                node: dojo.query('#nextend-accordion-menu-unique5ee0057 dl.level1')[0],
                instance: 'nextend-accordion-menu-unique5ee0057',
                url: '',
                moduleid: 0,
                classPattern: /nextend-nav-[0-9]+/,
                mode: 'onmouseenter', 
            ...
            dojo.query('.noscript').removeClass('noscript');
            new AccordionMenu({
                node: dojo.query('#nextend-accordion-menu-uniqued4ea544 dl.level1')[0],
                instance: 'nextend-accordion-menu-uniqued4ea544',
                url: '',
                moduleid: 0,
                classPattern: /nextend-nav-[0-9]+/,
                mode: 'onmouseenter', 
