        ...
        <?php endif; ?>
        		...
        		<form class="woocomerce-form woocommerce-form-login login register-form outer-top-xs" method="post">
        			...
        			<div class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide form-group">
        				...
        				<input type="text" class="woocommerce-Input woocommerce-Input--text input-text form-control unicase-form-control" name="username" id="username" value="<?php echo ( ! empty( $_POST['username'] ) ) ? esc_attr( $_POST['username'] ) : ''; ?>" autocomplete="username"/>
        			</div>
        			<div class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide form-group">
        				<label for="password" class="info-title"><?php _e( 'Password', 'flipmart' ); ?>&nbsp;<span class="required">*</span></label>
        				<input class="woocommerce-Input woocommerce-Input--text input-text form-control unicase-form-control" type="password" name="password" id="password" autocomplete="current-password"/>
        			</div>
        			...
        			<div class="form-row">
                        ...
                        <button type="submit" class="woocommerce-Button btn-upper btn btn-primary checkout-page-button" name="login" value="<?php esc_attr_e( 'Log in', 'flipmart' ); ?>"><?php esc_html_e( 'Log in', 'flipmart' ); ?></button>
        			</div>
        		...
        		<form method="post" class="woocommerce-form woocommerce-form-register register">
        			...
        			<?php if ( 'no' === get_option( 'woocommerce_registration_generate_username' ) ) : ?>
        				...
        				<div class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide form-group">
        					...
        					<input type="text" class="woocommerce-Input woocommerce-Input--text input-text form-control unicase-form-control text-input" name="username" id="reg_username" value="<?php echo ( ! empty( $_POST['username'] ) ) ? esc_attr( $_POST['username'] ) : ''; ?>" autocomplete="username"/>
        				</div>
        			...
        			<div class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide form-group">
        				...
        				<input type="email" class="woocommerce-Input woocommerce-Input--text input-text form-control unicase-form-control text-input" name="email" id="reg_email" value="<?php echo ( ! empty( $_POST['email'] ) ) ? esc_attr( $_POST['email'] ) : ''; ?>" autocomplete="email"/>
        			</div>
        			...
        			<?php if ( 'no' === get_option( 'woocommerce_registration_generate_password' ) ) : ?>
        				...
        				<div class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide form-group">
        					...
        					<input type="password" class="woocommerce-Input woocommerce-Input--text input-text form-control unicase-form-control text-input" name="password" id="reg_password" autocomplete="new-password"/>
        				</div>
