...
<div class="panel-heading">
	<h4 class="unicase-checkout-title"><?php echo apply_filters( 'woocommerce_my_account_my_address_description', __( 'The following addresses will be used on the checkout page by default.', 'flipmart' ) ); ?></h4>
</div>
...
<div class="row">
    <?php foreach ( $get_addresses as $name => $title ) : ?>
    	...
    	<div class="col-md-6 col-sm-6">
            ...
            <div class="panel-heading woocommerce-Address-title title">
            	<h4 class="unicase-checkout-title"><?php echo $title; ?></h4>
    		...
    		<address>
    			<?php
    				...
    				if ( ! $formatted_address )
    					_e( 'You have not set up this type of address yet.', 'flipmart' );
    				else
