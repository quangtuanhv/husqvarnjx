    ...
    <div class="register-form sign-in">
        <form method="post" class="woocommerce-ResetPassword lost_reset_password">
        	...
        	<p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first form-group">
        		...
        		<input class="woocommerce-Input woocommerce-Input--text form-control unicase-form-control text-input" type="text" name="user_login" id="user_login" autocomplete="username"/>
        	</p>
