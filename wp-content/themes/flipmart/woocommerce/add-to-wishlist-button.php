...
if( yog_helper()->yog_get_layout( 'version' ) == 'woomart' ){
  ...
  if( is_singular( 'product' ) ):
    ...
    ?>
    <a href="<?php echo esc_url( add_query_arg( 'add_to_wishlist', $product_id ) )?>" rel="nofollow" data-product-id="<?php echo $product_id ?>" data-product-type="<?php echo $product_type?>" class="add-to-cart" >
