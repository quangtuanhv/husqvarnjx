    ...
    <div class="dropdown dropdown-cart"> 
        <a href="#" class="dropdown-toggle lnk-cart" data-toggle="dropdown">
            <div class="items-cart-inner">
                <div class="basket"> <i class="fa fa-shopping-cart" aria-hidden="true"></i> </div>
                <div class="total-price-basket"> <span class="sign"><?php echo WC()->cart->get_cart_contents_count(); ?></span><span class="lbl"><?php echo esc_html__( 'items', 'flipmart' )?></span> <span class="total-price"></span> </div>
            </div>
        </a>
