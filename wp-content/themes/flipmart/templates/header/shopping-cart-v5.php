<?php if( yog_helper()->get_option( 'header-electro-add-cart' ) && class_exists('Woocommerce') ){  ?>
            ...
            <a href="#" class="dropdown-toggle lnk-cart" data-toggle="dropdown">
                <div class="items-cart-inner">
                  <div class="total-price-basket"> 
                     <?php printf ( '<span class="lbl">%s</span><span class="total-price">%s</span>',esc_html__( 'Your Cart', 'flipmart' ), WC()->cart->get_cart_total() ); ?>
                  </div>
                  <div class="basket"> 
                     <i class="fa fa-shopping-basket" aria-hidden="true"></i><span class="sign"><?php echo WC()->cart->get_cart_contents_count(); ?></span>
                  </div>
                </div>
            </a>
