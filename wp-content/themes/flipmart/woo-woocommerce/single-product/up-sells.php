...
if ( $upsells ) :
    ...
    //Animation
    $yog_animation = yog_helper()->get_option( 'product-sell-animation', 'raw', false, 'options' );
    $yog_delay     = yog_helper()->get_option( 'product-sell-delay', 'raw', false, 'options' );

?>
    
    <div <?php yog_helper()->attr( 'post', array( 'class' => 'box-additional', 'data-animation' => $yog_animation, 'data-animation-delay' => $yog_delay, 'id' => false ) ); ?>>
        <div class="related-pro container">
            <div class="slider-items-products">
		        <div class="new_title center"><h2><?php esc_html_e( 'You may also like&hellip;', 'flipmart' ) ?></h2></div>
