...
if( isset( $_GET['shop'] ) && !isset( $_COOKIE['gridcookie'] )){
    ...
    if( $_GET['shop'] == 'grid' ){
       ...
       $classes[] = 'col-lg-3 col-sm-3 col-xs-6 item'; 
       
       if($woocommerce_loop['loop'] % $woocommerce_loop['columns'] === 0) {  echo '</div><div class="row">';}
    }
    
    wc_get_template( 'woo-woocommerce/content-product-'. $_GET['shop']. '.php' , array( 'classes' => $classes ) );
    ...
    wc_get_template( 'woo-woocommerce/content-product-'.$_COOKIE['gridcookie'].'.php' , array( 'classes' => $classes ) );
   ...
   wc_get_template( 'woo-woocommerce/content-product-'.$shop_style.'.php' , array( 'classes' => $classes ) ); 
}