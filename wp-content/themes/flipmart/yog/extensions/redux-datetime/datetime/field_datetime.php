...
if (!class_exists('ReduxFramework_datetime')) {
    ...
    class ReduxFramework_datetime {
        ...
        public function render() {
            ...
            if (true == $split) {
                $date_placeholder = isset($this->field['placeholder']['date']) ? $this->field['placeholder']['date'] : __('Date', 'flipmart');
                $time_placeholder = isset($this->field['placeholder']['time']) ? $this->field['placeholder']['time'] : __('Time', 'flipmart');
            } else {
                $date_placeholder = isset($this->field['placeholder']) ? $this->field['placeholder'] : __('Date / Time', 'flipmart');
            }
        ...
        public function enqueue() {
            ...
            wp_enqueue_script(
                ...
                array('jquery', 'jquery-ui-datepicker', 'jquery-ui-widget', 'jquery-ui-slider', 'redux-datetime-slider-js'),
