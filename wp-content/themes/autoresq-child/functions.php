...
add_action( 'wp_enqueue_scripts', 'autoresq_child_enqueue_styles' );
function autoresq_child_enqueue_styles() {
    wp_enqueue_style( 'parent-style', get_template_directory_uri() . '/style.css' );

}

//load the translatins from child theme languages folder.
add_action( 'after_setup_theme', 'autoresq_child_setup' );
function autoresq_child_setup() {
    load_child_theme_textdomain( 'autoresq', get_stylesheet_directory() . '/languages' );
