...
function magikAspire_register_required_plugins()
{
    ...
    $config = array(
        ...
        /*
        'strings'      => array(
            'page_title'                      => __( 'Install Required Plugins', 'aspire' ),
            'menu_title'                      => __( 'Install Plugins', 'aspire' ),
            'installing'                      => __( 'Installing Plugin: %s', 'aspire' ), // %s = plugin name.
            'oops'                            => __( 'Something went wrong with the plugin API.', 'aspire' ),
            ...
            'return'                          => __( 'Return to Required Plugins Installer', 'aspire' ),
            'plugin_activated'                => __( 'Plugin activated successfully.', 'aspire' ),
            'activated_successfully'          => __( 'The following plugin was activated successfully:', 'aspire' ),
            'plugin_already_active'           => __( 'No action taken. Plugin %1$s was already active.', 'aspire' ),  // %1$s = plugin name(s).
            'plugin_needs_higher_version'     => __( 'Plugin not activated. A higher version of %s is needed for this theme. Please update the plugin.', 'aspire' ),  // %1$s = plugin name(s).
            'complete'                        => __( 'All plugins installed and activated successfully. %1$s', 'aspire' ), // %s = dashboard link.
            'contact_admin'                   => __( 'Please contact the administrator of this site for help.', 'aspire' ),
