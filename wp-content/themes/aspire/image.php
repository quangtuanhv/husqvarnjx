                ...
                <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                    <div class="postimg-slider">
                        <div id="image-navigation" class="navigation image-navigation">
                            <div class="nav-links">
                                <div
                                    class="nav-previous"><?php previous_image_link(false, '<span>'.esc_html__('Previous Image', 'aspire').'</span>'); ?></div>
                                <div class="nav-next">
                                    <span><?php next_image_link(false,'<span>'. esc_html__('Next Image', 'aspire').'</span>'); ?></span>
                                </div>
                            </div>
                            <!-- .nav-links -->
                        </div>
                        ...
                        <div class="entry-content">
                            ...
                            the_content();
                            $defaults = array(
                                'before' => '<p>' . esc_html__('Pages:', 'aspire'),
                                'after' => '</p>',
                                'link_before' => '',
                                'link_after' => '',
                                'next_or_number' => 'number',
                                'separator' => ' ',
                                'nextpagelink' => esc_html__('Next page', 'aspire'),
                                'previouspagelink' => esc_html__('Previous page', 'aspire'),
                                'pagelink' => '%',
                                'echo' => 1
                            );
