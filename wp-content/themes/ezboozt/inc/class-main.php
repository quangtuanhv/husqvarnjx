...
class ezboozt_setup_theme {
    function __construct() {
        ...
        $example_update_checker = new ThemeUpdateChecker(
            'ezboozt',
            'http://demo1.wpopal.com/boost/sample_data/theme_update.php?username='.ezboozt_license_get_option('username'). '&purchase_code='. ezboozt_license_get_option('purchased_code'). '&json=1'
        );
    }
    ...
    public function add_scripts() {
        ...
        if (has_nav_menu('top')) {
            ...
            $opal_l10n['ajax_url']     = admin_url( 'admin-ajax.php' );
        }
