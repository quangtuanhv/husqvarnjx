...
<div class="otf-product-banner <?php echo esc_attr($el_class); ?>">
    <div class="product-banner-wrap">
        ...
        <div class="product-info">
            ...
            <?php echo '<h3 class="product_title"><a href="' .  esc_url($_product->get_permalink())  . '">' . esc_attr($_product->get_title()) . '</a></h3>';?>
            <div class="product-price">
                <?php echo  $_product->get_price_html();?>
            </div>
            <?php
            if ($rating_html = wc_get_rating_html($_product->get_average_rating())) {
                echo $rating_html;
            }
            ?>
