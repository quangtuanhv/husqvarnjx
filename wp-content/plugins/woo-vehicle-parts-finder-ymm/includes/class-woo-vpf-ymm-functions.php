...
class WOO_VPF_YMM_Functions {
	...
	public static function get_year_label() {
		...
		if( $woo_vpf_ymm_year_label == '' ) {
			$woo_vpf_ymm_year_label = __( 'Year', WOO_VPF_YMM_TEXT_DOMAIN );
		}
	...
	public static function get_make_label() {
		...
		if( $woo_vpf_ymm_make_label == '' ) {
			$woo_vpf_ymm_make_label = __( 'Make', WOO_VPF_YMM_TEXT_DOMAIN );
		}
	...
	public static function get_model_label() {
		...
		if( $woo_vpf_ymm_model_label == '' ) {
			$woo_vpf_ymm_model_label = __( 'Model', WOO_VPF_YMM_TEXT_DOMAIN );
		}
	...
	public static function get_engine_label() {
		...
		if( $woo_vpf_ymm_engine_label == '' ) {
			$woo_vpf_ymm_engine_label = __( 'Engine', WOO_VPF_YMM_TEXT_DOMAIN );
		}
	...
	public static function get_category_label() {
		...
		if( $woo_vpf_ymm_category_label == '' ) {
			$woo_vpf_ymm_category_label = __( 'Category', WOO_VPF_YMM_TEXT_DOMAIN );
		}
	...
	public static function get_keyword_label() {
		...
		if( $woo_vpf_ymm_keyword_label == '' ) {
			$woo_vpf_ymm_keyword_label = __( 'Keyword', WOO_VPF_YMM_TEXT_DOMAIN );
		}
	...
	public static function get_search_results_label() {
		...
		if( $woo_vpf_ymm_search_results_label == '' ) {
			$woo_vpf_ymm_search_results_label = __( 'Search Results For:', WOO_VPF_YMM_TEXT_DOMAIN );
		}
	...
	public static function get_my_vehicles_save_title() {
		...
		if( $woo_vpf_ymm_my_vehicles_save_title == '' ) {
			$woo_vpf_ymm_my_vehicles_save_title = __( 'My Saved Vehicles', WOO_VPF_YMM_TEXT_DOMAIN );
		}
	...
	public static function get_my_vehicles_save_description() {
		...
		if( $woo_vpf_ymm_my_vehicles_save_description == '' ) {
			//$woo_vpf_ymm_my_vehicles_save_description = __( 'View, manage and find parts', WOO_VPF_YMM_TEXT_DOMAIN );
		}
	...
	public static function get_my_vehicles_save_no_item_text() {
		...
		if( $woo_vpf_ymm_my_vehicles_save_no_item_text == '' ) {
			//$woo_vpf_ymm_my_vehicles_save_no_item_text = __( 'You are yet to start saving search results', WOO_VPF_YMM_TEXT_DOMAIN );
		}
	...
	public static function get_my_vehicles_save_clear_history_text() {
		...
		if( $woo_vpf_ymm_my_vehicles_save_clear_history_text == '' ) {
			$woo_vpf_ymm_my_vehicles_save_clear_history_text = __( 'Clear History', WOO_VPF_YMM_TEXT_DOMAIN );
		}
	...
	public static function get_my_vehicles_history_title() {
		...
		if( $woo_vpf_ymm_my_vehicles_history_title == '' ) {
			$woo_vpf_ymm_my_vehicles_history_title = __( 'Vehicles History', WOO_VPF_YMM_TEXT_DOMAIN );
		}
	...
	public static function get_my_vehicles_history_description() {
		...
		if( $woo_vpf_ymm_my_vehicles_history_description == '' ) {
			//$woo_vpf_ymm_my_vehicles_history_description = __( 'Easily navigate the latest vehicles selected', WOO_VPF_YMM_TEXT_DOMAIN );
		}
	...
	public static function get_my_vehicles_history_no_item_text() {
		...
		if( $woo_vpf_ymm_my_vehicles_history_no_item_text == '' ) {
			//$woo_vpf_ymm_my_vehicles_history_no_item_text = __( 'You are yet to start searching vehicles', WOO_VPF_YMM_TEXT_DOMAIN );
		}
	...
	public static function get_my_vehicles_history_clear_history_text() {
		...
		if( $woo_vpf_ymm_my_vehicles_history_clear_history_text == '' ) {
			$woo_vpf_ymm_my_vehicles_history_clear_history_text = __( 'Clear History', WOO_VPF_YMM_TEXT_DOMAIN );
		}
	...
	public static function get_my_vehicles_add_vehicle_text() {
		...
		if( $woo_vpf_ymm_my_vehicles_add_vehicle_text == '' ) {
			$woo_vpf_ymm_my_vehicles_add_vehicle_text = __( 'Add a Vehicle', WOO_VPF_YMM_TEXT_DOMAIN );
		}
	...
	public static function get_my_vehicles_add_vehicle_heading() {
		...
		if( $woo_vpf_ymm_my_vehicles_add_vehicle_heading == '' ) {
			$woo_vpf_ymm_my_vehicles_add_vehicle_heading = __( 'Select Vehicle', WOO_VPF_YMM_TEXT_DOMAIN );
		}
	...
	public static function get_filter_widget_template( $args ) {
		$args = shortcode_atts( array(
			'title'			=> __( 'Vehicle Parts Filter', WOO_VPF_YMM_TEXT_DOMAIN ),
			'view'			=> 'V',
			'label_year'	=> __( 'Select Year', WOO_VPF_YMM_TEXT_DOMAIN ),
			'label_make'	=> __( 'Select Make', WOO_VPF_YMM_TEXT_DOMAIN ),
			'show_model'	=> '1',
			'label_model'	=> __( 'Select Model', WOO_VPF_YMM_TEXT_DOMAIN ),
			'show_engine'	=> '',
			'label_engine'	=> __( 'Select Engine', WOO_VPF_YMM_TEXT_DOMAIN ),
			'show_category'	=> '',
			'label_category'=> __( 'Select Category', WOO_VPF_YMM_TEXT_DOMAIN ),
			'show_keyword'	=> '1',
			'label_keyword'	=> __( 'Product Name', WOO_VPF_YMM_TEXT_DOMAIN ),
			'show_my_vehicles'	=> '',
			'label_search'	=> __( 'Search', WOO_VPF_YMM_TEXT_DOMAIN ),
			'label_reset_search'	=> __( 'Reset Search', WOO_VPF_YMM_TEXT_DOMAIN ),
		), $args );
					...
					<select name="make">
						...
						<?php
							if( isset( $year_id ) && $year_id > 0 ) {
								...
								self::get_terms_list( $year_id, $make );
							}
						?>
					</select>
				</div>
							...
							<select name="model">
								...
								<?php
									if( isset( $make ) && $make > 0 ) {
										...
										self::get_terms_list( $make, $model );
									}
								?>
							</select>
						</div><?php
								...
								<select name="engine">
									...
									<?php
										if( isset( $model ) && $model > 0 ) {
											...
											self::get_terms_list( $model, $engine );
										}
									?>
								</select>
							</div><?php
	...
	public static function insert_term( $name, $parent=0 ) {
		if ( '' == trim( $name ) ) {
			return new WP_Error( 'empty_term_name', __( 'A name is required for this term', WOO_VPF_YMM_TEXT_DOMAIN ) );
		}
