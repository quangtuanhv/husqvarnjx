...
public function mgk_plugins_panel_callback()
{
 ...
 public function mgk_plugins_submenu_panel_callback()
            {

                ?>

                 <h2> <?php esc_html_e("Magik Plugins Dashboard","magik-woosearchby-tag"); ?></h2>
                    <div class="mgkplugins_panel_wrap">
                        <div class="mgk_plugin_seaction">
                           
                 
                 <ul class="mgkplugin_link">
                     
              <?php if(class_exists('MGK_CatalogMode'))
              {
                 $menu_slug="mgkcmo_admin_settings";
                 ?>
                  <li><a href="<?php  menu_page_url( $menu_slug);?>"><?php esc_html_e('Magik Catalog Mode',"magik-woosearchby-tag");?></a></li>
                
                <?php
              }
              ?>

                <?php if(class_exists('MGK_InfiniteScroll'))
              {
                 $menu_slug="mgkisr_admin_settings";
                 ?>
                 <li><a href="<?php  menu_page_url( $menu_slug);?>"><?php esc_html_e('Magik Infinite Scroller',"magik-woosearchby-tag");?></a></li>
                
                <?php
              }
              ?>

                <?php if(class_exists('MGK_SocialShare'))
              {
                 $menu_slug="mgkssh_admin_settings";
                 ?>
                 <li><a href="<?php  menu_page_url( $menu_slug);?>"><?php esc_html_e('Magik Social Share',"magik-woosearchby-tag");?></a></li>
                
                <?php
              }
              ?>

                <?php if(class_exists('MGK_WooAjaxSearch'))
              {
                 $menu_slug="mgkwooas_admin_settings";
                 ?>
                 <li><a href="<?php  menu_page_url( $menu_slug);?>"><?php esc_html_e('Magik Woo Ajax Search',"magik-woosearchby-tag");?></a></li>
                
                <?php
              }
              ?>
                 <?php if(class_exists('MGK_WooCategory'))
              {
                 $menu_slug="mgkwci_admin_settings";
                 ?>
                 <li><a href="<?php  menu_page_url( $menu_slug);?>"><?php esc_html_e('Magik Woo Category Image',"magik-woosearchby-tag");?></a></li>
                
                <?php
              }
              ?>

                  <?php if(class_exists('MGK_WooSearchByTag'))
              {
                 $menu_slug="mgkwst_admin_settings";
                 ?>
                 <li><a href="<?php  menu_page_url( $menu_slug);?>"><?php esc_html_e('Magik Woo Search By Tag',"magik-woosearchby-tag");?></a></li>
