...
class OTF_Scripts {
    ...
    public function add_frontend_scripts() {
        ...
        wp_register_script('otf-spritespin', trailingslashit(OPAL_THEME_FRAMEWORK_PLUGIN_URL) . '/assets/js/spritespin.js', array('jquery'), '20150315', true);
...
//            }
            ...
            if (has_shortcode($post->post_content, 'otf_rotate_images') || has_shortcode($post->post_content, 'otf_rotate_images')) {
                wp_enqueue_script('otf-spritespin');
            }
        }
