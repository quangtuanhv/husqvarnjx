    ...
    'params'                  => array(
        array(
            ...
            'value'      => array(
                ...
                esc_html__('Style 2', 'opal-theme-framework') => 'opal-style-2',
            ),
            "std"        => '',
        ),
        array(
	    ...
	    array(
		    "type"       => "dropdown",
		    "heading"    => esc_html__("Button Align", 'opal-theme-framework'),
		    "param_name" => "button_align",
		    'value'      => array(
			    esc_html__('Button Left', 'opal-theme-framework')   => 'button_left',
			    esc_html__('Button Right', 'opal-theme-framework') => 'button_right',
		    ),
		    "std"        => 'button_left',
		    'dependency' => array(
			    'element' => 'style',
