...
return array(
    ...
    "category"                => 'Opal Theme',
    "as_parent"               => array('only' => 'vc_btn,vc_custom_heading,vc_column_text,vc_empty_space,single_img,vc_wp_custommenu,vc_separator,vc_text_separator'), // Use only|except attributes to limit child shortcodes (separate multiple values with comma)
