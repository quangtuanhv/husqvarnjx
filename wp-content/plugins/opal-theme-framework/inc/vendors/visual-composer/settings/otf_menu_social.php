...
return array(
    ...
    "params"         => array(
        ...
        array(
            "type"       => "dropdown",
            "heading"    => esc_html__("Size", 'opal-theme-framework'),
            "param_name" => "shape_size",
            "description" => esc_html__("Select social size", 'opal-theme-framework'),
            'value'      => array(
                esc_html__('Mini', 'opal-theme-framework') => 'mini',
                esc_html__('Small', 'opal-theme-framework') => 'small',
                esc_html__('Normal', 'opal-theme-framework') => 'normal',
