...
return array(
    ...
    "params"          => array(
        array(
            'type'        => 'checkbox',
            'heading'     => esc_html__('Enable button', 'opal-theme-framework'),
        ...
        array(
            'type'       => 'textfield',
            'heading'    => esc_html__('Text', 'opal-theme-framework'),
            'param_name' => 'text_button',
            "value"      => 'Shop now',
            'group'      => __('Button', 'opal-theme-framework'),
            'dependency' => array(
        ...
        array(
            'type'       => 'textfield',
            'heading'    => esc_html__('Link', 'opal-theme-framework'),
