...
if (!function_exists('otf_cart_link_fragment')) {
    ...
    function otf_cart_link_fragment($fragments) {
        ...
        ob_start();
        $fragments['a.cart-contents .amount'] = otf_cart_amount();
        $fragments['a.cart-contents .count'] = otf_cart_count();
        $fragments['a.cart-contents .count-text'] = otf_cart_count_text();
...
if (!function_exists('otf_cart_amount')) {
    /**
     *
     * @return string
     *
     */
    function otf_cart_amount() {
        if(!empty(WC()->cart) && WC()->cart instanceof WC_Cart) {
...
if (!function_exists('otf_cart_count')) {
    /**
     *
     * @return string
     *
     */
    function otf_cart_count() {
        if(!empty(WC()->cart) && WC()->cart instanceof WC_Cart) {
...
if (!function_exists('otf_cart_count_text')) {
    /**
     *
     * @return string
     *
     */
    function otf_cart_count_text() {
        if(!empty(WC()->cart) && WC()->cart instanceof WC_Cart) {
            return '<span class="count-text">' . wp_kses_data(_n("item", "items", WC()->cart->get_cart_contents_count(), "opal-theme-framework")) . '</span>';
            }
        return '';
    }
}
