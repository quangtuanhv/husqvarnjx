...
@media screen and (min-width: {$containerBoxedPx}px){
    ...
    {$containerBoxedSelector} .vc_row[data-vc-full-width][data-vc-stretch-content] {
        width: {$containerBoxedPx}px !important;
        left: calc((( -{$containerBoxedPx}px + {$containerPx}px) / 2)) !important;
    }
}
CSS;
