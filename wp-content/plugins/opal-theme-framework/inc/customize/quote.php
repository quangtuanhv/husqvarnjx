...
$quote_font  = get_theme_mod( 'otf_typography_quotes_font_family' );
$color       = get_theme_mod( 'otf_colors_quotes_color', '#666' );
$background  = get_theme_mod( 'otf_colors_quotes_background', 'rgba(255,255,255,0)' );
$borderColor = get_theme_mod( 'otf_colors_quotes_border', '#eceeef' );
...
$quote_font_style = get_theme_mod( 'otf_typography_quotes_font_style' );
