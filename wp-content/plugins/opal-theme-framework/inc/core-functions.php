...
function otf_get_fonts_url() {
    ...
    //Vertical  Menu Font
    $vertical_font = get_theme_mod('otf_typography_vertical_menu_font_family');
    if (is_array($vertical_font) && $vertical_font['family']) {
        //        $font_families[] = "{$quotes_font['family']}";
        $font_families[] = "{$vertical_font['family']}:{$vertical_font['fontWeight']}";
        $subsets[]       = $vertical_font['subsets'];
    }
